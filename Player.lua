        ...
        ['jumping'] = function(dt)
            ...
            if self.map:collides(self.map:tileAt(self.x, self.y + self.height)) or
                self.map:collides(self.map:tileAt(self.x + self.width - 1, self.y + self.height)) then
                  if self.map:tileAt(self.x, self.y + self.height).id == FLAG_1 then
                          self.dx = 0
                          self.dy = -15
...
function Player:checkLeftCollision()
    if self.dx < 0 then
        ...
        if self.map:collides(self.map:tileAt(self.x - 1, self.y)) or
            ...
            --if pole:
            if self.map:tileAt(self.x - 1, self.y).id == FLAG_1 or
              self.map:tileAt(self.x - 1, self.y).id == FLAG_POLE_TOP or
                self.map:tileAt(self.x - 1, self.y).id == FLAG_POLE_MIDDLE or
                  self.map:tileAt(self.x - 1, self.y).id == FLAG_POLE_BASE then
                    self.dx = 0
                    self.dy = -15
...
function Player:checkRightCollision()
    if self.dx > 0 then
        ...
        if self.map:tileAt(self.x + self.width, self.y).id == FLAG_1 or
          self.map:tileAt(self.x + self.width, self.y).id == FLAG_POLE_TOP or
            self.map:tileAt(self.x + self.width, self.y).id == FLAG_POLE_MIDDLE or
              self.map:tileAt(self.x + self.width, self.y).id == FLAG_POLE_BASE then
                self.dx = 0
                self.dy = -15
